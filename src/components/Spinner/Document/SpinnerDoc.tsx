                ...
                <FlexLayout spacing="extraTight" direction="vertical">
                  <FlexLayout spacing="extraTight" wrap="noWrap">
                    ...
                    <TextStyles
                      ...
                      utility="storybook-doc--paragraph"
                    >
                      Do not present spinner outside the button. It subsists as
                      an embedded component with button.
                    </TextStyles>
                  </FlexLayout>
                ...
                <FlexLayout spacing="extraTight" direction="vertical">
                  <FlexLayout spacing="extraTight" wrap="noWrap">
                    ...
                    <TextStyles
                      ...
                      utility="storybook-doc--paragraph"
                    >
                      Do not use Loading button in popup modal. Instead, use
                      buttons.
                    </TextStyles>
                  </FlexLayout>
                  <div className="inner_card_custom">
                ...
                <FlexLayout spacing="extraTight" direction="vertical">
                  <FlexLayout spacing="extraTight" wrap="noWrap">
                    ...
                    <TextStyles
                      ...
                      utility="storybook-doc--paragraph"
                    >
                      When a page is loading, use skeleton instead of spinner.
                      Skeleton screens shift the attention of users. It makes
                      people focus on the progress, rather than the wait time.
                    </TextStyles>
                  </FlexLayout>
                  <div className="inner_card_custom">
                    <FlexLayout spacing="tight">
