...
const TextEditor = ({
  ...
  const findCaretPosition = () => {
    ...
    console.log(selection , navigator.clipboard.readText())
  ...
  return (
    <div className='inte-textEditor'>
      <div className='inte-textEditor__toolbar'>
        ...
        <Button size='extraThin' onClick={() => setCurrStyleApplied(prev => ({ ...prev, italic: !prev.italic }))} type={currStyleApplied.italic ? "secondary" : "outlined"}><i>I</i></Button>
        <Button size='extraThin' onClick={() => setCurrStyleApplied(prev => ({ ...prev, underline: !prev.underline }))} type={currStyleApplied.underline ? "secondary" : "outlined"}><u>U</u></Button>
      </div>
      <div
        ref={editorRef}
