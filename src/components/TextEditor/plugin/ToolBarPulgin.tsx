...
import { Bold, Italic, List, ListIcon, Underline } from '../../../icons';
...
<>
          <Button
            ...
            size='extraThin'
            // customClass={"toolbar-item spaced " + (isBold ? "active" : "")}
          ...
          <Button
            ...
            // customClass={"toolbar-item spaced " + (isItalic ? "active" : "")}
          ...
          <Button
            ...
            // customClass={"toolbar-item spaced " + (isUnderline ? "active" : "")}
            aria-label="Format Underline"
          >
            <Underline size="16" color="#1c2433" />
          </Button>
          <Button size='extraThin' type={isList ? "secondary" : "outlined"} onClick={() => editor.dispatchCommand(INSERT_UNORDERED_LIST_COMMAND, undefined)}>
