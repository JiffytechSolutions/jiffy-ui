...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "<blockquote>Toggles are usually used to activate or deactivate a specific setting amongst the set.</blockquote>",
      },
    },
  },
  argTypes: {
    ...
    options: {
      ...
      description:
        '<table><thead><tr><th>Property</th><th>Type</th><th>Description</th></tr></thead><tbody><tr><td><code>label</code></td><td><code>string | React.ReactNode</code></td><td>The label for the option.</td></tr><tr><td><code>description</code></td><td><code>string | React.ReactNode</code></td><td>An optional description for the option.</td></tr><tr><td><code>value<span style="color: red;">*</span></code></td><td><code>any</code></td><td>The value of the option.</td></tr><tr><td><code>isDisabled</code></td><td><code>boolean</code></td><td>To disable the option.</td></tr><tr><td><code>helpText</code></td><td><code>string</code></td><td>To show tooltip in label.</td></tr><tr><td><code>helpPosition</code></td><td><code>"left"|"right"|"top"|"bottom"</code></td><td>To set the position of tooltip</td></tr></tbody></table>',
    },
    direction: {
