...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: "<blockquote>A choice list is an interactive component that allows users to select one or more options from a list of predefined choices.</blockquote>"
      },
    },
  },
  argTypes: {
    ...
    isClickableFullItem : {
      description : "Make the full item clickable (default only lable of radio is clickable)",
      control : {
        type : 'boolean'
      },
      defaultValue : false
